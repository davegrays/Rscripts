...
# score the model
predictions_raw <- predict(model, data_test_ohe, type="response", n.trees=1000)
...
write.csv(predictions, file="results_Rscript2_1000trees_ALLTRAIN.csv", quote=TRUE, row.names=FALSE)
